...
def get_mst_longest_path_from_triangles(tr_output):
    """
    Convert triangulated strokes to a minimum spanning stree (MST), then calculate its longest path through BFS.
    This function is supposed to be used in the line fitting operators
    """
    def e_dist(i,j):
